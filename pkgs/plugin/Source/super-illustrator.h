...
namespace suai {
  ...
  void log_serialize(const char* format, Args... args) {
    csl(format, args...);
  }
  ...
  namespace art {
    ...
    namespace serialize {
      ...
      json AIFillStyleToJSON(const AIFillStyle& fill) {
        ...
        log_serialize("  Serialize: AIFillStyleToJSON");
      ...
      json AIRealBezierToJSON(const AIRealBezier& bezier) {
        log_serialize(
            "  Serialize: AIRealBezierToJSON\n{p0: %f, %f, p1: %f, %f, "
            "p2: %f, %f, p3: %f, %f}",
            bezier.p0.h, bezier.p0.v, bezier.p1.h, bezier.p1.v, bezier.p2.h, bezier.p2.v,
            bezier.p3.h, bezier.p3.v
        );
      ...
      json AIPathSegmentsToJSON(AIArtHandle& path) {
        ...
        log_serialize("  Serialize: AIPathSegmentsToJSON");
      ...
      json AIPathStyleToJSON(const AIPathStyle& style) {
        log_serialize("Serialize: AIPathStyleToJSON");
      ...
      std::optional<json> ArtObjectToJson(AIArtHandle art, int depth, int maxDepth) {
        ...
        log_serialize(
            "Serialize: ArtObjectToJSON(type: %s, name: %s)", getTypeName(art).c_str(),
            artName.c_str()
        );
      ...
      json ArtToJSON(AIArtHandle art, int maxDepth = 100) {
        log_serialize("Serialize: ArtToJSON");
